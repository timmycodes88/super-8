        ...
        <SignInContainer>
            <SignInBox>
                <FormSpacer>
                    ...
                    {!showSignIn && <PasswordConfirm type='password' placeholder="Confirm Password"></PasswordConfirm>}
                    <SubmitButton onClick={signIn}>{showSignIn ? 'Sign In' : 'Create Account' }</SubmitButton>
                <ToggleSignIn onClick={() => setShowSignIn(!showSignIn)}>{showSignIn ? 'Create Account' : 'Sign In' }</ToggleSignIn>
                </FormSpacer> 
            </SignInBox>
        </SignInContainer>
    </Body>
